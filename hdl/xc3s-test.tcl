...
proc set_process_props {} {
   ...
   project set "Target UCF File Name" "/home/vivado/xc3s-test/foo.ucf" -process "Back-annotate Pin Locations"
   ...
   project set "Place MultiBoot Settings into Bitstream" "true" -process "Generate Programming File"
   ...
   project set "Report Paths by Endpoint" "20" -process "Generate Post-Place & Route Static Timing"
   ...
   project set "Report Unconstrained Paths" "20" -process "Generate Post-Place & Route Static Timing"
   ...
   project set "Work Directory" "/home/vivado/xc3s-test/xst" -process "Synthesize - XST"
   ...
   project set "MultiBoot: Starting Address for Next Configuration" "0x00020000" -process "Generate Programming File"
